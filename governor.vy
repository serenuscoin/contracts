...
minimum_leverage_ratio: public(uint256)
...
def __init__():
    ...
    self.minimum_leverage_ratio = 12000                   # in bips
...
@public
def setParameters(_issuer_fees: uint256, _minimum_leverage_ratio: uint256,
    ...
    self.minimum_leverage_ratio = _minimum_leverage_ratio # in bips
